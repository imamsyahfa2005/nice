...
const iklan = require("./lib/iklan.js");
//
...
if (text.includes("©anime"))
   ...
   {
    var items = ["aesthetic hd", "aesthetic gaming", "aesthetic cewe cina", "aestehtic cewe korea", "aestehtic cowo cina", "aestehtic cowo korea", "aesthetic cowo Indonesia", "aesthetic cewe Indonesia"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
...
if (text.includes("©pokemon"))
   {
    var items = ["anime pokemon", "pokemon HD", "pokemon berubah"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
