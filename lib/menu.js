exports.menu = (id, BotName, corohelp, tampilTanggal, tampilWaktu, instagramlu, whatsapplu, merenung, kapanbotaktif, grupch1, grupch2) => {
	return `🐔 *MENU ${BotName}* 🐔
...
Perintah: #p [cewek/cowok]
Contoh: #p cewek

➥7.#loli
_${BotName} akan mengirimkan foto loli UwU secara random_
Perintah: #loli
Contoh: #loli

➥7.#pokemen
_${BotName} akan mengirimkan foto pokemon UwU secara random_
Perintah: #pokemon
Contoh: #pokemen
...
➥6.#tiktok [LINK]
_${BotName} akan mengirimkan video/foto twitter sesuai perintah yang kamu kirim!_
Contoh: #tiktok https://twitter.com/yoi
...
♨️ GROUP NGOBROL [1] : https://chat.whatsapp.com/HaT3rqLA0RBGjePOh0HgGG
